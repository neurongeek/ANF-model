function Istim = stim_L11(SinglePulse,Rate,mod_TotalTime,mod_RampTime,mod_DeadTime,Duration,Fs)
% Input-
...
%                                   e.g. [100, -1, +1];
% Rate                    Carrier Pulse rate
% mod_TotalTime     Period of a single modulation for a trapezoidal modulator
% mod_RampTime    Period of a ramp of the trapezoidal modulator
% mod_DeadTime     Silence between the modulations
...
mod_single = mod_TotalTime;
mod_ramp = mod_RampTime; % Ramp duration in second
mod_silence = mod_DeadTime; % Silence duration in second
mod_steady = mod_single - (2*mod_ramp + mod_silence); % Steady state duration in second
